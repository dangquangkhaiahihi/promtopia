                    ...
                    <div className="flex items-center">
                        ...
                        >
                            ...
                            <g
                                ...
                                fillRule="evenodd"
                            >
                                <g transform="translate(-852.000000, -102.000000)">
                                <g transform="translate(303.000000, 102.000000)">
                                    ...
                                    <g>
                                        ...
                                        <g
                                        strokeLinecap="round"
                                        transform="translate(10.735157, 10.632020) rotate(-9.000000) translate(-10.735157, -10.632020) translate(2.235157, 5.263599)"
                                        stroke="#ffffff"
                                        strokeWidth="0.8"
                                        >
                                        <polyline
                                            transform="translate(5.830469, 5.598202) rotate(9.000000) translate(-5.830469, -5.598202) "
                                            points="1.35678474 1.1245181 6.0975063 10.0718865 10.3041532 6.03597723"
                                        />
                                        <polyline
                                            transform="translate(6.784174, 5.296309) rotate(9.000000) translate(-6.784174, -5.296309) "
                                            points="1.41575288 1.26999362 10.8187298 6.27031557 12.152595 9.3226252"
                                        />
                                        <line
                                            x1="8.92892695"
                                            y1="8.12445114"
                                            x2="11.6131375"
                                            y2="9.91392482"
                                            transform="translate(10.271032, 9.019188) rotate(9.000000) translate(-10.271032, -9.019188) "
                                        />
                                        <polyline
                                            transform="translate(8.901535, 3.366942) rotate(9.000000) translate(-8.901535, -3.366942) "
                                            points="1.74364069 1.57746822 16.0594302 2.31288991 12.2457603 5.15641559"
                                        />
                                        <polyline
                                            transform="translate(6.784174, 5.296309) rotate(9.000000) translate(-6.784174, -5.296309) "
                                            points="1.41575288 1.26999362 12.152595 4.86711944 12.149983 9.3226252"
                                        />
                                        </g>
                                    </g>
                                    </g>
                        ...
                        <button
                            ...
                            className="ml-1.5 hidden px-1.5 [transition:transform_0.3s_ease-in-out] lg:block"
                        >
                            <svg
                            role="img"
                            aria-hidden="true"
                            ...
                            <path
                                fill="#282f2f"
                                d="M14.1 14.751a5.53 5.53 0 1 1 .651-.651L19 18.348l-.652.652-4.248-4.249zm-3.557.4a4.608 4.608 0 1 0 0-9.216 4.608 4.608 0 0 0 0 9.215z"
                            />
                            </svg>
                        </button>
                        <div className="absolute left-[2.375rem] flex h-[1.875rem] w-[26rem] items-center justify-start overflow-hidden [transition:transform_0.3s_ease-in-out,opacity_0.2s_ease-in-out] lg:justify-between pointer-events-none opacity-0">
                            <div className="pointer-events-none opacity-0 [transition:transform_0.3s_ease-in-out,opacity_0.2s_ease-in-out] lg:hidden">
                            <svg
                                role="img"
                                aria-hidden="true"
                                width={32}
                            ...
                            <input
                                type="text"
                                placeholder="Search..."
                                className="relative w-[13.5rem] bg-transparent py-1 pl-2 font-pt-serif italic text-time-gray-1 antialiased outline-none lg:w-96"
                                name="q"
                                defaultValue=""
                            />
                            </form>
                            <button
                            type="button"
                            className="relative top-[0.0625rem] hidden px-3 lg:block"
